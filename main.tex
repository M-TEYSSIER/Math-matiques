...
\usepackage{amsmath} % Fonctions Mathématiques (Général)
\usepackage{amssymb} % Fonctions Mathématiques (Symboles)
\usepackage{tikz} % Dessiner
\usepackage{pgfplots} % Dessiner des fonctions

\begin{document}
 \begin{center}
    \section*{\fbox{Cercle trigo}}\\ 
    \vspace{0.3cm}
    \begin{tikzpicture}
        \draw (0,0) circle (1);
